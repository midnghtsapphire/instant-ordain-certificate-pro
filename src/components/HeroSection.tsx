    ...
    <section className="pt-20 pb-16 px-4">
      <div className="max-w-6xl mx-auto text-center">
        <div className="flex justify-center mb-6">
          <Badge variant="secondary" className="bg-gradient-to-r from-everunity-gold-100 to-everunity-gold-200 text-everunity-gold-800 border-everunity-gold-300">
        ...
        <div className="flex items-center justify-center mb-4">
          <Church className="h-6 w-6 text-everunity-purple-600 mr-2" />
          <p className="text-lg text-gray-700 font-medium">
            Ordination services provided through <span className="text-everunity-purple-600 font-semibold">EverUnity Church</span> (Non-Profit 501c3)
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button size="lg" className="bg-gradient-to-r from-everunity-blue-600 to-everunity-purple-600 hover:from-everunity-blue-700 hover:to-everunity-purple-700 text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
            <Award className="mr-2 h-5 w-5" />
            Get Ordained Now - FREE
          </Button>
          <Dialog>
            <DialogTrigger asChild>
              <Button size="lg" variant="outline" className="border-2 border-everunity-purple-300 hover:border-everunity-purple-500 hover:bg-everunity-purple-50 px-8 py-4 text-lg font-semibold rounded-xl">
