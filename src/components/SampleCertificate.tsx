...
const SampleCertificate = () => {
  return (
    <div className="bg-white border-4 border-amber-400 p-8 rounded-lg shadow-lg">
      <div className="text-center space-y-6">
        <div className="border-b-2 border-amber-300 pb-4">
          ...
          <h2 className="text-3xl font-bold text-sky-800">EverUnity Church</h2>
        ...
        <div className="py-6">
          ...
          <div className="border-b-2 border-gray-300 mx-auto w-64 mb-6">
            <p className="text-xl font-bold text-amber-700 pb-2">[Your Name Here]</p>
          </div>
        ...
        <div className="flex justify-between items-end pt-6 border-t-2 border-amber-300">
